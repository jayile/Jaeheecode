...
<script>
	...
	function serch_ajax1() {
		...
		var serch = $('#serch').val();
		var re = 'memberlist2.do?value='+serch;
...
<table class="table table-hover">
	...
	<tbody>
		...
		<ul class="pagination justify-content-center">
            ...
            <c:otherwise>
            	<li class="page-item">
                	<a class="page-link" href="memberlist.do?page=1" aria-label="Previous">
                  		<span aria-hidden="true">&laquo;</span>
                	</a>
            	</li>
			</c:otherwise>
			...
			<c:otherwise>
				<li class="page-item">
            		<a class="page-link" href="memberlist.do?page=${page.curPage - 1}">Previous</a>
            	</li>
			</c:otherwise>
			</c:choose>
            ...
            <c:forEach var="fEach" begin="${page.startPage}" end="${page.endPage}" step="1">
				...
				<c:when test="${page.curPage == fEach}">
					...
					<c:otherwise>
            <li class="page-item">
            	<a class="page-link" href="memberlist.do?&page=${fEach}">${fEach}</a>
            </li>
            </c:otherwise>
				</c:choose>
			</c:forEach>
			...
			<c:otherwise>
				<li class="page-item">
                	<a class="page-link" href="memberlist.do?page=${page.curPage + 1}">Next</a>
            	</li>
			</c:otherwise>
			</c:choose>
			...
			<c:otherwise>
				<li class="page-item">
                	<a class="page-link" href="memberlist.do?page=${page.totalPage}" aria-label="Next">
                  	<span aria-hidden="true">&raquo;</span>
                	</a>
            	</li>
			</c:otherwise>
